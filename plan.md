...
## 개요
단일 `index.html` 파일에 한영 토글 기능을 추가합니다.

### 구현 상태
- **v0.6** (2026-03-23): UI 요소, 힌트, 토스트, 섹션 제목 등 80+ 키 번역 시스템 구축 완료
- **v0.7** (2026-03-23): 기본 뷰 플레이스홀더 텍스트(이름, 회사, Phase, 업무, 스킬, 업무스타일) 60+ 키 추가 번역 완료
